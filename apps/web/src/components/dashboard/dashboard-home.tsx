        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[
            ...
            <button
              ...
              disabled={isLoading}
              className={`px-4 py-2 rounded-xl bg-white/5 border border-white/5 text-sm transition-all ${
                isLoading
                  ? "opacity-50 cursor-not-allowed"
                  : "hover:bg-white/10 hover:border-white/10 text-gray-400 hover:text-gray-200"
              }`}
            >
              {item}
            </button>
