 ...
 * Updated: 2024-12-24 via MCP Server documentation
 */
const PACKAGE_VERSIONS: Record<string, string> = {
  ...
  // Animation - Motion (new name for framer-motion)
  motion: "^12.0.0",
  "framer-motion": "^12.0.0", // Legacy alias
  ...
  // Dev dependencies (minimal for JS projects)
  eslint: "^9.0.0",
...
`,
  ...
  "app/layout.js": (projectName: string) => `import './globals.css';
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <p className="text-gray-400 text-center max-w-md">
        Your Next.js application is ready. Start editing app/page.js to customize this page.
      </p>
    </main>
  );
}
